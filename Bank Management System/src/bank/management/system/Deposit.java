    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource()==proc){
                int balance=10;
                Con c = new Con();
                String query1 =" select * from balance where email = '"+unm+"'";
                try{
                 ...
                 balance+=amt;
                 String q2= "UPDATE balance SET balance ='"+balance+"'  where email ='"+unm+"'";
                ...
                String dt = date.toString();
                 String w = "Deposit";
                 String q3 = "insert into transaction(email,date_time,amount,status) values('"+unm+"','"+dt+"','"+amt+"','"+w+"')";
